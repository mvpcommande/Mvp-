import{n as e,t}from"./styles-CA22tAoU.js";import"./modulepreload-polyfill-P2Xu9kJm.js";import{a as n,c as r,f as i,o as a,r as o}from"./restaurantResolver-B1dJEPxX.js";import{t as s}from"./errorLog-DYeNOlWf.js";async function c(e,t,n){let{data:r,error:i}=await e.auth.signInWithPassword({email:t,password:n});if(i)throw i;return r.session}async function l(e){let{data:t,error:n}=await e.auth.getSession();if(n)throw n;return t.session}async function u(e){let{error:t}=await e.auth.signOut();if(t)throw t}function d(e){let t=new Map;for(let n of e??[]){let e=n.order_items??n.items??[];for(let n of e){let e=n.product_name??n.name??`Article`,r=n.options?.meat??``,i=n.options?.sauce??``,a=n.options?.drink??``,o=[e,r,i,a].join(`|`),s=Number(n.quantity??0),c=Math.round(n.line_total_cents??(n.price??0)*s*100),l=t.get(o);l?(l.quantity+=s,l.revenueCents+=c):t.set(o,{name:e,meat:r,sauce:i,drink:a,quantity:s,revenueCents:c})}}return[...t.values()].sort((e,t)=>t.quantity-e.quantity||e.name.localeCompare(t.name))}function ee(e){let t=e=>{let t=String(e??``);return/[;"\n]/.test(t)?`"${t.replace(/"/g,`""`)}"`:t},n=[`Article`,`Viande`,`Sauce`,`Boisson`,`Quantité`,`Total (€)`],r=(e??[]).map(e=>[e.name,e.meat,e.sauce,e.drink,e.quantity,(e.revenueCents/100).toFixed(2).replace(`.`,`,`)].map(t).join(`;`));return[n.join(`;`),...r].join(`
`)}function te(e,t,n){let r=t?new Date(`${t}T00:00:00`).getTime():-1/0,i=n?new Date(`${n}T23:59:59.999`).getTime():1/0;return(e??[]).filter(e=>{let t=new Date(e.createdAt??e.created_at).getTime();return t>=r&&t<=i})}function f(e){let t=e=>{let t=String(e??``);return/[;"\n]/.test(t)?`"${t.replace(/"/g,`""`)}"`:t},n=[`Numéro de commande`,`Date`,`Heure de retrait`,`Client`,`Téléphone`,`Montant TTC (€)`,`Statut paiement`,`Statut commande`],i=(e??[]).map(e=>{let n=new Date(e.createdAt??e.created_at),i=Number.isNaN(n.getTime())?``:n.toLocaleDateString(`fr-FR`);return[e.number??e.order_number??``,i,r(e.pickupTime??e.pickup_time),e.customer?.name??e.customer_name??``,e.customer?.phone??e.customer_phone??``,(e.total??(e.total_cents??0)/100).toFixed(2).replace(`.`,`,`),e.paymentStatus??e.payment_status??``,e.status??``].map(t).join(`;`)});return[n.join(`;`),...i].join(`
`)}function p(e,t={},n=(e=``,t=`_blank`)=>window.open(e,t)){let r=n(``,`_blank`);if(!r)return!1;let i=e=>`${(Number(e||0)/100).toFixed(2).replace(`.`,`,`)} €`,a=(e??[]).reduce((e,t)=>e+t.quantity,0),o=(e??[]).reduce((e,t)=>e+t.revenueCents,0),s=(e??[]).map(e=>`
  ...
  `),r.document.close(),r.focus(),r.print(),!0}function m(e,t){if(!t||t<=0)return null;let n=(e??[]).filter(e=>e.status!==`CANCELLED`),r=n.reduce((e,t)=>e+Math.round(Number(t.total??(t.total_cents??0)/100)*100),0);return{orderCount:n.length,totalCents:r,savingsCents:Math.round(r*t)}}function h(e,t,n){if(!e)return null;let r=`caz-food-orders-${Date.now()}`,i=e.channel(r,{config:{broadcast:{self:!1},presence:{key:``}}}).on(`postgres_changes`,{event:`INSERT`,schema:`public`,table:`orders`},e=>{t(e)}).on(`postgres_changes`,{event:`UPDATE`,schema:`public`,table:`orders`},e=>{t(e)}).on(`postgres_changes`,{event:`DELETE`,schema:`public`,table:`orders`},e=>{t(e)});return i.subscribe((e,t)=>{t&&console.error(`[Realtime] Erreur:`,t),e===`CHANNEL_ERROR`&&console.error(`[Realtime] CHANNEL_ERROR`,t),e===`TIMED_OUT`&&console.error(`[Realtime] TIMED_OUT`),e===`CLOSED`&&console.warn(`[Realtime] Canal fermé`),n?.(e,t)}),i}function g(e,n=(e=``,t=`_blank`)=>window.open(e,t),i=null){let a=n(``,`_blank`);if(!a)return!1;let o=e.order_items??e.items??[],s=e=>`${(Number(e||0)/100).toFixed(2).replace(`.`,`,`)} €`,c=r(e.pickup_time),l=o.map(e=>`
        <div class="row">
          <div>
            <strong>
...
`&&r.push(10)}return i&&i.type===`pulse`&&(r=r.slice(0,0-this.#e.newline.length)),Uint8Array.from(r)}#f(e,t){if(t===`strict`||this.#e.errors===`strict`)throw Error(e);return console.warn(e),this}static get printerModels(){return Object.entries(O).map((e=>({id:e[0],name:e[1].vendor+` `+e[1].model})))}get columns(){return this.#r.columns}get language(){return this.#e.language}get printerCapabilities(){return this.#i}},de=class{constructor(e){this._events={}}on(e,t){this._events[e]=this._events[e]||[],this._events[e].push(t)}emit(e,...t){let n=this._events[e];n&&n.forEach((e=>{setTimeout((()=>e(...t)),0)}))}},k=[{filters:[{vendorId:1155,productId:22339}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`default`},{filters:[{vendorId:1046,productId:20497}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`zjiang`},{filters:[{vendorId:1155,productId:22592}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`mpt`},{filters:[{vendorId:1049},{vendorId:5380}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`bixolon`},{filters:[{vendorId:1305}],configuration:1,interface:0,language:e=>{let t=`star-line`,n=e.productName;switch(n=n.replace(/^Star\s+/i,``),n=n.replace(/^TSP(1|4|6|7|8|10)(13|43)(.*)?$/,((e,t,n,r)=>`TSP`+t+`00`+(r||``))),n=n.replace(/^TSP(55|65)(1|4)(.*)?$/,((e,t,n,r)=>`TSP`+t+`0`+(r||``))),n=n.replace(/^TSP([0-9]+)(II|III|IV|V|VI)?(.*)?$/,((e,t,n)=>`TSP`+t+(n||``))),n){case`TSP100IV`:case`mPOP`:case`mC-Label3`:case`mC-Print3`:case`mC-Print2`:t=`star-prnt`;break;case`TSP100`:case`TSP100II`:case`TSP100III`:t=`star-graphics`;break;case`BSC10`:case`BSC10BR`:case`BSC10II`:t=`esc-pos`}return t},codepageMapping:`star`},{filters:[{vendorId:1208}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`epson`},{filters:[{vendorId:7568}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`citizen`},{filters:[{vendorId:1497}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`hp`},{filters:[{vendorId:1221}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`epson`},{filters:[{vendorId:4070,productId:33054}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`epson`},{filters:[{vendorId:8137,productId:8214}],configuration:1,interface:0,language:`esc-pos`,codepageMapping:`xprinter`}],A=class{},j=class extends A{#e;#t=null;#n=null;#r={input:null,output:null};constructor(){super(),this.#e=new de,navigator.usb.addEventListener(`disconnect`,(e=>{this.#t==e.device&&this.#e.emit(`disconnected`)}))}async connect(){try{let e=await navigator.usb.requestDevice({filters:k.map((e=>e.filters)).reduce(((e,t)=>e.concat(t)))});e&&await this.#i(e)}catch(e){console.log(`Could not connect! `+e)}}async reconnect(e){let t=await navigator.usb.getDevices(),n=t.find((t=>t.serialNumber==e.serialNumber));n||=t.find((t=>t.vendorId==e.vendorId&&t.productId==e.productId)),n&&await this.#i(n)}async#i(e){this.#t=e,this.#n=k.find((e=>e.filters.some((e=>e.vendorId&&e.productId?e.vendorId==this.#t.vendorId&&e.productId==this.#t.productId:e.vendorId==this.#t.vendorId)))),await this.#t.open(),await this.#t.selectConfiguration(this.#n.configuration),await this.#t.claimInterface(this.#n.interface);let t=this.#t.configuration.interfaces.find((e=>e.interfaceNumber==this.#n.interface));this.#r.output=t.alternate.endpoints.find((e=>e.direction==`out`)),this.#r.input=t.alternate.endpoints.find((e=>e.direction==`in`)),await this.#t.reset(),this.#e.emit(`connected`,{type:`usb`,manufacturerName:this.#t.manufacturerName,productName:this.#t.productName,serialNumber:this.#t.serialNumber,vendorId:this.#t.vendorId,productId:this.#t.productId,language:await this.#a(this.#n.language),codepageMapping:await this.#a(this.#n.codepageMapping)})}async#a(e){return typeof e==`function`?await e(this.#t):e}async listen(){if(this.#r.input)return this.#o(),!0}async#o(){if(this.#t)try{let e=await this.#t.transferIn(this.#r.input.endpointNumber,64);e instanceof USBInTransferResult&&e.data.byteLength&&this.#e.emit(`data`,e.data),this.#o()}catch{}}async disconnect(){this.#t&&(await this.#t.close(),this.#t=null,this.#n=null,this.#e.emit(`disconnected`))}async print(e){if(this.#t&&this.#r.output)try{await this.#t.transferOut(this.#r.output.endpointNumber,e)}catch(e){console.log(e)}}addEventListener(e,t){this.#e.on(e,t)}};function M(e=typeof navigator<`u`?navigator:null){return!!(e&&`usb`in e)}function N(e,t,n={}){let r=e.order_items??e.items??[],i=e=>`${(Number(e||0)/100).toFixed(2).replace(`.`,`,`)} EUR`,a=new t({language:n.language||`esc-pos`,codepageMapping:n.codepageMapping||`epson`});a.initialize().codepage(`auto`).align(`center`).bold(!0).line(n.restaurantName||`FOODATOI`).bold(!1).line(e.order_number??e.number??`—`).align(`left`).rule();for(let e of r){let t=e.product_name??e.name??``,n=e.quantity??1,r=e.line_total_cents??Math.round((e.price||0)*n*100);a.bold(!0).line(`${n}x ${t}`).bold(!1);let o=[];e.options?.meat&&o.push(`Viande: ${e.options.meat}`),e.options?.sauce&&o.push(`Sauce: ${e.options.sauce}`),e.options?.drink&&o.push(`Boisson: ${e.options.drink}`),o.length&&a.line(o.join(` - `)),a.align(`right`).line(i(r)).align(`left`)}a.rule(),e.notes&&a.bold(!0).line(`NOTE:`).bold(!1).line(e.notes).rule();let o=e.total_cents??Math.round((e.total||0)*100);return a.size(2,2).bold(!0).align(`right`).line(`TOTAL ${i(o)}`).bold(!1).size(1,1).align(`left`).newline().newline().cut(),a.encode()}function P(e,t=typeof localStorage<`u`?localStorage:null){let n=new e,r=null,i=`foodatoi-thermal-printer-device`;n.addEventListener(`connected`,e=>{r=e,t&&t.setItem(i,JSON.stringify(e))});function a(){if(!t)return;let e=t.getItem(i);if(e)try{n.reconnect(JSON.parse(e))}catch{}}async function o(){return await n.connect(),r}function s(){return!!r}function c(){return r}function l(e){if(!r)throw Error(`PRINTER_NOT_CONNECTED`);return n.print(e)}return{connect:o,tryAutoReconnect:a,isConnected:s,getDeviceInfo:c,printBytes:l}}var F=document.querySelector(`#admin-root`),I=M()?P(j):null;I&&I.tryAutoReconnect();function L(e,t){if(I?.isConnected())try{let n=N(e,ue,{restaurantName:t,language:I.getDeviceInfo()?.language||`esc-pos`,codepageMapping:I.getDeviceInfo()?.codepageMapping});I.printBytes(n);return}catch(e){console.error(`[FOODATOI admin] Échec impression thermique, repli navigateur:`,e)}g(e,void 0,t)}var R={NEW:`Nouvelle`,ACCEPTED:`Acceptée`,PREPARING:`En préparation`,READY:`Prête`,CANCELLED:`Annulée`},z=null,B=`local`,V=null,H=null,U=null;function W(){return JSON.parse(localStorage.getItem(`caz-food-orders`)||`[]`)}function fe(e){localStorage.setItem(`caz-food-orders`,JSON.stringify(e))}function G(e){return`${Number(e).toFixed(2).replace(`.`,`,`)} €`}async function K(){if(!e){pe();return}try{H=await l(e)}catch(e){console.error(`Erreur récupération session:`,e),Y();return}if(H){try{U=await o(e)}catch(t){console.error(`Erreur résolution restaurant:`,t),s(e,{context:`admin.resolveRestaurant`,message:t?.message??String(t),page:`admin`}),J(t);return}z=a(e,U.id),B=`remote`,q(),await X();return}Y()}function q(){V&&e&&e.removeChannel(V),e&&H?.access_token&&e.realtime.setAuth(H.access_token),V=h(e,()=>X(),t=>{(t===`CLOSED`||t===`TIMED_OUT`||t===`CHANNEL_ERROR`)&&B===`remote`&&(console.warn(`[Realtime] Reconnexion dans 3s...`),s(e,{restaurantId:U?.id,context:`admin.realtime`,message:`Canal realtime perdu (${t}), reconnexion dans 3s`,page:`admin`}),setTimeout(()=>{B===`remote`&&q()},3e3))})}function pe(){F.innerHTML=`
  ...
  `,F.querySelector(`#retry-restaurant`).onclick=()=>K()}function Y(t=``){F.innerHTML=`
    <main class="admin-auth">
      <div class="auth-card">
        <div class="auth-mark">
          F
  ...
  `;let n=F.querySelector(`#login-form`);n.onsubmit=async t=>{t.preventDefault();let n=new FormData(t.currentTarget),r=t.currentTarget.querySelector(`button`);r.disabled=!0,r.textContent=`CONNEXION…`;try{H=await c(e,n.get(`email`),n.get(`password`))}catch(e){console.error(`Erreur connexion admin:`,e),Y(`Email ou mot de passe incorrect.`);return}try{U=await o(e),z=a(e,U.id),B=`remote`,q(),await X()}catch(e){console.error(`Erreur résolution restaurant:`,e),J(e)}}}async function me(){if(B===`remote`)try{return await z.listOrders()}catch(e){return console.error(`Erreur récupération commandes:`,e),[]}return W()}async function he(t){let n={NEW:`ACCEPTED`,ACCEPTED:`PREPARING`,PREPARING:`READY`}[t.status];if(n)try{B===`remote`?await z.updateStatus(t.id,n):fe(i(W(),t.id,n)),await X()}catch(r){console.error(`Erreur changement statut:`,r),s(e,{restaurantId:U?.id,context:`admin.updateStatus`,message:r?.message??String(r),details:{orderId:t.id,from:t.status,to:n},page:`admin`}),alert(`Impossible de modifier le statut de la commande.`)}}async function X(){if(!H&&B===`remote`){Y();return}let n=(await me()).slice().sort((e,t)=>new Date(t.created_at??t.createdAt)-new Date(e.created_at??e.createdAt)),r=n.reduce((e,t)=>e+Number(t.total??(t.total_cents??0)/100),0);F.innerHTML=`
    <main class="admin-shell">
      ...
      ${(()=>{let e=m(n,U?.settings?.uber_eats_commission_rate);return!e||!e.orderCount?``:`
  ...
  `;let i=F.querySelector(`#logout`);i&&(i.onclick=async()=>{try{V&&e&&await e.removeChannel(V),e&&await u(e)}finally{H=null,U=null,z=null,B=`local`,V=null,Y()}}),F.querySelectorAll(`[data-next]`).forEach(e=>{e.onclick=()=>{let t=n.find(t=>String(t.id??``)===String(e.dataset.id));t&&he(t)}}),F.querySelectorAll(`[data-print]`).forEach(e=>{e.onclick=()=>{let t=n.find(t=>String(t.id??``)===String(e.dataset.id));t&&L(t,U?.name)}});let a=F.querySelector(`#export-stock`);a&&(a.onclick=()=>ge(n));let o=F.querySelector(`#export-accounting`);o&&(o.onclick=()=>Q(n));let s=F.querySelector(`#connect-printer`);s&&I&&(s.hidden=!1,s.textContent=I.isConnected()?`Imprimante : ${I.getDeviceInfo()?.productName||`connectée`}`:`Connecter l'imprimante`,s.onclick=async()=>{s.textContent=`Connexion…`;try{await I.connect(),s.textContent=`Imprimante : ${I.getDeviceInfo()?.productName||`connectée`}`}catch(e){console.error(`[FOODATOI admin] Connexion imprimante annulée ou échouée:`,e),s.textContent=`Connecter l'imprimante`}});let c=F.querySelector(`#system-health`);c&&(c.onclick=()=>ye());let l=F.querySelector(`#print-stock`);l&&(l.onclick=()=>p(d(n),{rangeLabel:`${n.length} commande${n.length>1?`s`:``} affichée${n.length>1?`s`:``}`,restaurantName:U?.name})),F.querySelectorAll(`.order-card`).forEach(e=>{e.onclick=t=>{if(t.target.closest(`button`))return;let r=n.find(t=>String(t.id??``)===String(e.dataset.order));r&&ve(r)}})}function ge(e){let t=ee(d(e)),n=new Blob([`﻿`+t],{type:`text/csv;charset=utf-8;`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`${Z()}-stock-${new Date().toISOString().slice(0,10)}.csv`,i.click(),URL.revokeObjectURL(r)}function Z(){return(U?.name||`foodatoi`).toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`foodatoi`}function _e(e,t,n){let r=f(te(e,t,n)),i=new Blob([`﻿`+r],{type:`text/csv;charset=utf-8;`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.href=a;let s=t||n?`${t||`debut`}_${n||`fin`}`:new Date().toISOString().slice(0,10);o.download=`${Z()}-comptabilite-${s}.csv`,o.click(),URL.revokeObjectURL(a)}function Q(e){let t=document.createElement(`div`);t.id=`accounting-export-overlay`,t.className=`modal`,t.innerHTML=`
  ...
  `,document.body.appendChild(a),a.onclick=e=>{e.target===a&&$()},a.querySelector(`#close-order-detail`).onclick=$,a.querySelector(`#print-from-detail`).onclick=()=>L(e,U?.name),B===`remote`&&z?.getOrderEvents)try{let t=await z.getOrderEvents(e.id),n=a.querySelector(`#detail-timeline`);if(!n)return;n.innerHTML=`
        <p class="eyebrow">
          Historique
        </p>
        ${t.length?`
              <ul class="detail-timeline-list">
                ${t.map(e=>`
                      <li>
                        ...
                        ${R[e.from_status]??e.from_status??`—`}
                        →
                        ${R[e.to_status]??e.to_status}
                      </li>
                    `).join(``)}
              </ul>
            `:`
            ...
            `}
      `}catch(e){console.error(`Erreur historique commande:`,e);let t=a.querySelector(`.detail-timeline-loading`);t&&(t.textContent=`Historique indisponible.`)}}async function ye(){let e=document.createElement(`div`);if(e.id=`system-health-overlay`,e.className=`modal`,e.innerHTML=`
    <div class="modal-card order-detail-card">
      <button
        class="modal-close"
  ...
  `,document.body.appendChild(e),e.onclick=t=>{t.target===e&&e.remove()},e.querySelector(`#close-system-health`).onclick=()=>e.remove(),!(B!==`remote`||!z?.getRecentErrors))try{let t=await z.getRecentErrors(),n=e.querySelector(`#health-loading`);if(!n)return;n.outerHTML=t.length?`
      ...
      `}catch(t){console.error(`Erreur chargement état système:`,t);let n=e.querySelector(`#health-loading`);n&&(n.textContent=`Impossible de charger les logs.`)}}function be(e){let t=e.status,i=e.items??e.order_items??[],a={...e.customer??{},name:e.customer?.name??e.customer_name??`Client`,phone:e.customer?.phone??e.customer_phone??`—`,pickupTime:r(e.pickup_time)},o=e.number??e.order_number??`—`,s=e.total??(e.total_cents??0)/100,c=n(t),l=c?`
        <button
          class="primary"
          data-next
          data-id="${e.id}"
